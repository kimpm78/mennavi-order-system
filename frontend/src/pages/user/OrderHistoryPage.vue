...
const points = computed(() => Math.floor(totalAmount.value * 0.1))
    ...
    <div class="mt-9 grid gap-6 lg:grid-cols-[minmax(0,1fr)_356px]">
      <section>
        ...
        <div v-else class="grid gap-6">
          ...
          >
            <div class="ramen-photo ramen-photo-clear min-h-[188px] md:min-h-full" />
            ...
            <div class="p-6">
              ...
              <div class="mt-7 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      ...
      <aside class="grid content-start gap-6">
        <section class="rounded-lg border border-red-200 bg-neutral-100 p-6">
          <h2 class="text-2xl font-black tracking-normal">Summary</h2>
          <dl class="mt-6 grid gap-0 text-base font-bold">
            ...
            <div class="flex justify-between py-4">
              ...
              <dd class="text-2xl font-black text-red-700">{{ points.toLocaleString('ja-JP') }} pts</dd>
            </div>
          </dl>
          <button
